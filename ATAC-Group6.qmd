...
cutoffs <- list(
  "NT" = list(peak_region_fragments_lower = 3000, peak_region_fragments_upper = 20000, 
              pct_reads_in_peaks_lower = 20, blacklist_ratio_upper = 0.01, 
              nucleosome_signal_upper = 4, TSS_enrichment_lower = 3),
  "Batch 1" = list(peak_region_fragments_lower = 3000, peak_region_fragments_upper = 20000, 
              pct_reads_in_peaks_lower = 20, blacklist_ratio_upper = 0.01, 
              nucleosome_signal_upper = 4, TSS_enrichment_lower = 2),
...
```{r}
seurat_list_2 <- list('Batch1' = TTs.batch1.seu, 'Batch2' = TTs.batch2.seu
)
```
...
TTs.batch2.seu <- RunUMAP(NTs.combined.seu, dims = 1:50, reduction = 'lsi')
