...
```{r}
merged.seu <- merge(seurat_list_qc$PT1, y = c(seurat_list_qc$PT2, seurat_list_qc$PT3,
                                                 seurat_list_qc$RT1,
                                                 seurat_list_qc$RT2 ,
                                              seurat_list_qc$RT3,
                                              seurat_list_qc$NT1,
                                              seurat_list_qc$NT2), 
                       add.cell.ids = c("PT1", "PT2", "PT3", "RT1", "RT2", "RT3", "NT1", "NT2"), 
...
```{r}
saveRDS(integrated.seu, file = "data/scRNA/integratedTT_NT_all.rds")
