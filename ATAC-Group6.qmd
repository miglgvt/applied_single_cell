...
TTs.batch1.seu.filtered <- seurat_list_qc[["Batch 2"]]
```

```{r}
saveRDS(NTs.combined.seu.filtered, 'data/scATAC/NTs.atac.seu.filtered.rds')
saveRDS(TTs.batch1.seu.filtered, 'data/scATAC/TTs.batch1.atac.seu.filtered.rds')
saveRDS(TTs.batch2.seu.filtered, 'data/scATAC/TTs.batch2.atac.seu.filtered.rds')
```

```{r}
NTs.combined.seu.filtered <- readRDS()
TTs.batch1.seu.filtered <- readRDS()
TTs.batch1.seu.filtered <- readRDS()
```
